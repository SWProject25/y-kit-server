...
public class PolicyDetail {
    ...
    public static PolicyDetail from(PolicyDetailEntity detail) {
        return PolicyDetail.builder()
                ...
                .approvalStatus(detail.getPlcyAprvSttsCd() != null ? detail.getPlcyAprvSttsCd().getDescription() : null)
                .provisionMethod(detail.getPlcyPvsnMthdCd() != null ? detail.getPlcyPvsnMthdCd().getDescription() : null)
                ...
                .businessPeriodType(detail.getBizPrdSeCd() != null ? detail.getBizPrdSeCd().getDescription() : null)
