...
public class PolicyQualification {
    ...
    public static PolicyQualification from(PolicyQualificationEntity entity) {
        return PolicyQualification.builder()
                ...
                .incomeConditionType(entity.getEarnCndSeCd() != null ? entity.getEarnCndSeCd().name() : null)
                .minIncome(entity.getEarnMinAmt())
                .maxIncome(entity.getEarnMaxAmt())
                .incomeEtc(entity.getEarnEtcCn())
                .maritalStatus(entity.getMrgSttsCd() != null ? entity.getMrgSttsCd().name() : null)
                .educationLevel(entity.getSchoolCd() != null ? entity.getSchoolCd().name() : null)
                .employmentStatus(entity.getJobCd() != null ? entity.getJobCd().name() : null)
                .majorField(entity.getPlcyMajorCd() != null ? entity.getPlcyMajorCd().name() : null)
                .specializedRequirement(entity.getSbizCd() != null ? entity.getSbizCd().name() : null)
